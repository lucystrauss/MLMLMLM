...
from copy import deepcopy # for making copy of dataloader for recon (demo) callback

from typing import Dict, Optional, Union
from prefigure.prefigure import get_all_args, push_wandb_config
from stable_audio_tools.data.emg_rvq_dataset import create_dataloader_from_config, fast_scandir
...
from stable_audio_tools.emg_rvq_training import create_training_wrapper_from_config, create_demo_callback_from_config
...
def main():
    ...
    if args.pretrained_ckpt_path:
        ...
        print('DEBUG: using pretrained checkpoint path')
    ...
    if args.val_dataset_config:
        print("val dataset is configured")
        demo_callback = create_demo_callback_from_config(model_config, demo_dl=val_dl)
    else:
        # Create a separate demo dataloader from the same dataset
        print("val dataset is NOT configured")
        #from copy import deepcopy
        demo_dat = deepcopy(train_dl)  # or however you create dataloaders
        demo_callback = create_demo_callback_from_config(model_config, demo_dl=demo_dat)
