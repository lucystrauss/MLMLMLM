...
if __name__ == '__main__':
    ...
    print('memory after model loaded', torch.cuda.mem_get_info(device))
    ...
    if model_type == 'autoencoder':
        from stable_audio_tools.emg_training.autoencoders import AutoencoderTrainingWrapper
        ...
        print('gpu device:', device)
        print('memory just before making training wrapper', torch.cuda.mem_get_info(device))
